...
class TRTInference:
    ...
    def __init__(self, ENGINE_PATH, batch_size):
        ...
        # # init detect_plate
        # engine_file_path_1 = './model/mssd512_voc.engine'  # "./model/m512.engine"
        # engine_file_path_2 = './model/model12_sim.engine'  # "./model/m12.engine"
        # engine_file_path_3 = './model/ocr_plate_all_w_rnn_2.engine'  # "./model/o2.engine"
        # # self.cuda_ctx = None  # to be created when run
        # self.detect_ = detectPlate.detect_plate(engine_file_path_1, engine_file_path_2, engine_file_path_3, self.context)
